...
void FlirGige::CacheParams() {
  ...
  std::cout << "get width: " << width << std::endl;
  std::cout << "get height: " << height << std::endl;

  int64_t bit;
  param_array_->GetEnumValue("DigitalOutput", bit);
  std::cout << "get bit: " << bit << std::endl;

  int64_t SensorFrameRate;
  param_array_->GetEnumValue("SensorFrameRate", SensorFrameRate);
  std::cout << "get SensorFrameRate: " << SensorFrameRate << std::endl;

  int64_t SensorVideoStandard;
  param_array_->GetEnumValue("SensorVideoStandard", SensorVideoStandard);
  std::cout << "get SensorVideoStandard: " << SensorVideoStandard << std::endl;
...
void FlirGige::SetPixelFormat(bool raw) const {
  //param_array_->SetEnumValue("SensorFrameRate", static_cast<int64_t>(0));
  ...
  std::cout << "Set fps 30......" << std::endl;
  param_array_->SetEnumValue("SensorVideoStandard", static_cast<int64_t>(0));
}
